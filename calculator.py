...
user_oper1 = input('Enter in the first operator (Use: *, /, +, -): ')
...
user_oper2 = input('Enter in the second operator (Use: *, /, +, -): ')
...
# Prints the full operator entered by the user while converting the variables to strings.
print('Entered operator:', str(user_num1), str(user_oper1),
